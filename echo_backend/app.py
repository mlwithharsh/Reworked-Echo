...
def process_text():
    ...
    try:
        ...
        # Get analysis first to show in metric cards
        analysis = nlp_engine.analyze(user_text, memory_manager)
        
        # Get response using router (which uses personality and memory)
        response_text = personality_router.get_response(user_text, memory_manager)
